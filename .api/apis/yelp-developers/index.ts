...
class SDK {
  ...
  ): Promise<FetchResponse<200, types.V3BusinessSearchResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.V3BusinessPhoneSearchResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.V3BusinessMatchResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.V3BusinessInfoResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.V3TransactionSearchResponse200>> {
    return this.core.fetch(
  ...
  ): Promise<FetchResponse<200, types.V3GetBusinessesEngagementResponse200>> {
  ...
  ): Promise<FetchResponse<200, types.V3BusinessServiceOfferingsResponse200>> {
    return this.core.fetch(
   ...
   */
  v3_business_rapc_enabledness(
    body: types.V3BusinessRapcEnablednessBodyParam,
    metadata: types.V3BusinessRapcEnablednessMetadataParam
   ...
   */
  v3_businesses_insights(
    metadata: types.V3BusinessesInsightsMetadataParam
  ): Promise<FetchResponse<200, types.V3BusinessesInsightsResponse200>> {
  ...
  v3_get_business_food_and_drinks_insights(
    metadata: types.V3GetBusinessFoodAndDrinksInsightsMetadataParam
  ): Promise<
    FetchResponse<200, types.V3GetBusinessFoodAndDrinksInsightsResponse200>
  > {
    return this.core.fetch(
   ...
   */
  v3_post_natural_language_search(
    body: types.V3PostNaturalLanguageSearchBodyParam
  ): Promise<FetchResponse<200, types.V3PostNaturalLanguageSearchResponse200>> {
    return this.core.fetch(
      "/v3/businesses/natural_language_search",
      "post",
      body
    );
  }
...
export type {
  ...
  V3BusinessRapcEnablednessBodyParam,
  V3BusinessRapcEnablednessMetadataParam,
  V3BusinessRapcEnablednessResponse400,
  V3BusinessRapcEnablednessResponse401,
  V3BusinessRapcEnablednessResponse403,
  V3BusinessRapcEnablednessResponse404,
  V3BusinessRapcEnablednessResponse413,
  V3BusinessRapcEnablednessResponse429,
  V3BusinessRapcEnablednessResponse500,
  V3BusinessRapcEnablednessResponse503,
  ...
  V3BusinessesInsightsMetadataParam,
  V3BusinessesInsightsResponse200,
  V3BusinessesInsightsResponse400,
  V3BusinessesInsightsResponse401,
  V3BusinessesInsightsResponse403,
  V3BusinessesInsightsResponse404,
  V3BusinessesInsightsResponse413,
  V3BusinessesInsightsResponse429,
  V3BusinessesInsightsResponse500,
  V3BusinessesInsightsResponse503,
  V3GetBusinessFoodAndDrinksInsightsMetadataParam,
  V3GetBusinessFoodAndDrinksInsightsResponse200,
  V3GetBusinessFoodAndDrinksInsightsResponse400,
  V3GetBusinessFoodAndDrinksInsightsResponse401,
  V3GetBusinessFoodAndDrinksInsightsResponse403,
  V3GetBusinessFoodAndDrinksInsightsResponse404,
  V3GetBusinessFoodAndDrinksInsightsResponse413,
  V3GetBusinessFoodAndDrinksInsightsResponse429,
  V3GetBusinessFoodAndDrinksInsightsResponse500,
  V3GetBusinessFoodAndDrinksInsightsResponse503,
  ...
  V3PostNaturalLanguageSearchBodyParam,
  V3PostNaturalLanguageSearchResponse200,
  V3PostNaturalLanguageSearchResponse400,
  V3PostNaturalLanguageSearchResponse401,
  V3PostNaturalLanguageSearchResponse403,
  V3PostNaturalLanguageSearchResponse404,
  V3PostNaturalLanguageSearchResponse413,
  V3PostNaturalLanguageSearchResponse429,
  V3PostNaturalLanguageSearchResponse500,
  V3PostNaturalLanguageSearchResponse503,
